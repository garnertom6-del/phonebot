...
export default function NewIntake() {
  ...
  function applyNoteFields(fields: IntakeNoteField[], onlyIfEmpty = false) {
    ...
    // A pasted phone shows the Text-destination box, but the "I confirmed this
    // mobile number" attestation is staff's explicit tap - never pre-ticked.
  }
              ...
              <label htmlFor="new-intake-phone">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    // never auto-tick the confirmation; only clear it if the phone stops being valid
                    setSendSmsAfterCreate((prev) => prev && !!assigned.phone && !assigned.error);
